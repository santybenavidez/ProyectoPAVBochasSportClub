...
namespace ProyectoBOCHAS
{
    public partial class frmInscripcionADisciplina : Form
    {
        ...
        private void btnRecibo_Click(object sender, EventArgs e)
        {
            ...
            {
                transaccion.encabezadoInscripcionADisciplina(txtTotal.Text, "Inscripcion"); //FALTA EL NOMBRE DEL CLIENTE
                for (int i = 0; i < dgvInscripcionSocioADisciplina.Rows.Count; i++)
                {
                ...
                if (bandera)
                {
                    ...
                    frmRecibo frmRecibo = new frmRecibo(txtCliente.Text, txtDomicilio.Text, nroRecibo);
